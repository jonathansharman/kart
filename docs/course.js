...
export class Course {
    constructor(name, laps, originOffset, track, walls) {
        this.name = name;
        this.laps = laps;
        this.track = track;
        this.walls = walls;
...
export const TEST_COURSES = [
    new Course("Serpentine", 3, 500.0, new Track(TRACK_RADIUS, 0.88, new SplineLoop(corner(100, 100, 0.5), corner(100, 668, 0.5), corner(250, 668, 1.0), corner(250, 200, 1.0), corner(450, 200, 1.0), corner(450, 668, 1.0), corner(650, 668, 1.0), corner(650, 200, 1.0), corner(850, 200, 1.0), corner(850, 668, 1.0), corner(1000, 668, 0.5), corner(1000, 100, 0.5))), []),
    new Course("Clockwise oval, tight turns", 10, -100.0, new Track(TRACK_RADIUS, 0.125, new SplineLoop(corner(300, 300, 0.0), corner(800, 300, 0.0), corner(800, 500, 0.0), corner(300, 500, 0.0))), [
        new Wall(new SplineLoop(corner(350, 350, 0.0), corner(750, 350, 0.0), corner(750, 450, 0.0), corner(350, 450, 0.0)))
    ]),
    new Course("Counter-clockwise oval", 10, 150.0, new Track(TRACK_RADIUS, 0.0, new SplineLoop(corner(300, 300, 1.0), corner(300, 500, 1.0), corner(800, 500, 1.0), corner(800, 300, 1.0))), [
        new Wall(new SplineLoop(corner(350, 350, 1.0), corner(350, 450, 1.0), corner(750, 450, 1.0), corner(750, 350, 1.0)))
    ]),
    new Course("Clockwise big track, tight turns", 4, -200.0, new Track(TRACK_RADIUS, 0.0625, new SplineLoop(corner(0, 0, 0.0), corner(1000, 0, 0.0), corner(1000, 600, 0.0), corner(900, 600, 0.0), corner(700, 500, 0.0), corner(300, 500, 0.0), corner(100, 600, 0.0), corner(0, 600, 0.0))), [
    ...
    new Course("Counter-clockwise big track", 4, 400.0, new Track(TRACK_RADIUS, 0.0, new SplineLoop(corner(0, 0, 0.5), corner(0, 600, 1.0), corner(100, 600, 1.0), corner(300, 500, 1.0), corner(700, 500, 1.0), corner(900, 600, 1.0), corner(1000, 600, 1.0), corner(1000, 0, 0.5))), [
    ...
    new Course("Degenerate quad (triangle)", 1, 500.0, new Track(TRACK_RADIUS, 0.0, new SplineLoop(corner(300, 300, 1.0), corner(300, 500, 1.0), corner(800, 400, 1.0), corner(800, 400, 1.0))), []),
];
